...
let cat = new Cat('Meowth', 9, 'cream')
...
let siriusBlack = new Wizard('Sirius Black', 36, 'Mobilicorpus!')

siriusBlack.castSpell()
...
let phone1 = new Phone('Apple', 'Iphone12', 16 , 'rose gold', 1000)
let phone2 = new Phone('Samsung', 'Galaxy', 16, 'black', 900 )
let phone3 = new Phone ('LG', 'Blade', 16, 'purple', 800)
